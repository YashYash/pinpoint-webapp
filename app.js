...
app.use(function(req, res, next) {
  res.setHeader('Access-Control-Allow-Origin', 'http://localhost:5000', 'https://pinpoint-ionic.herokuapp.com/', 'https://pinpoint-ionic-mobile.herokuapp.com', 'https://www.pinpoint-mobile.com');
